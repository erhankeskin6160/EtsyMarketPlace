...
internal static class UiStyle
{
    ...
    public static void PopulateSidebarNavItems(SimilarProductsWinForms.Controls.ModernSidebarNav sidebarNav, string activeItemId)
    {
        ...
        sidebarNav.AddItem("aras_shipping", "Aras Global Kargo", "🚚", "Otomasyon & Araçlar", "YENİ");
        sidebarNav.AddItem("shipentegra_shipping", "ShipEntegra Kargo", "📦", "Otomasyon & Araçlar", "YENİ");
