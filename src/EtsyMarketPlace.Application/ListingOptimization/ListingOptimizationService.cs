...
public sealed class ListingOptimizationService
{
    ...
    private static IReadOnlyList<string> BuildMaterialSuggestions(ListingOptimizationInput input)
    {
        ...
        AddIfMentioned(blob, candidates, "pla", "pla plastic");
        AddIfMentioned(blob, candidates, "plastic", "plastic");
        AddIfMentioned(blob, candidates, "wood", "wood");
        AddIfMentioned(blob, candidates, "ahsap", "wood");
        ...
        AddIfMentioned(blob, candidates, "ceramic", "ceramic");
        AddIfMentioned(blob, candidates, "seramik", "ceramic");
        AddIfMentioned(blob, candidates, "clay", "clay");
        AddIfMentioned(blob, candidates, "leather", "leather");
        AddIfMentioned(blob, candidates, "deri", "leather");
        AddIfMentioned(blob, candidates, "concrete", "concrete");
        AddIfMentioned(blob, candidates, "beton", "concrete");
        AddIfMentioned(blob, candidates, "glass", "glass");
        AddIfMentioned(blob, candidates, "cam", "glass");
        AddIfMentioned(blob, candidates, "cotton", "cotton");
        AddIfMentioned(blob, candidates, "pamuk", "cotton");
        AddIfMentioned(blob, candidates, "linen", "linen");
        AddIfMentioned(blob, candidates, "keten", "linen");
        AddIfMentioned(blob, candidates, "silver", "sterling silver");
        AddIfMentioned(blob, candidates, "gumus", "sterling silver");
        AddIfMentioned(blob, candidates, "gold", "gold");
        AddIfMentioned(blob, candidates, "altin", "gold");
        AddIfMentioned(blob, candidates, "brass", "brass");
        AddIfMentioned(blob, candidates, "pirinc", "brass");
